...
export type ContentToBackground =
  | { type: "IMPRESSION_RECORDED"; campaignId: string; url: string; category: string; publisherAddress: string; clearingCpmPlanck?: string; campaignTags?: string[]; policyId?: number; interestWeightBps?: number; auctionRootCommit?: string }
