...
export function Settings({ address }: { address: string | null }) {
  ...
  async function saveTags() {
    ...
    try {
      ...
      const tx = await contract.setPublisherTags(hashes);
      await tx.wait();
              ...
              try {
                ...
                setSettings((s) => ({
                  ...
                  contractAddresses: {
                    ...
                    lifecycle: addrs.lifecycle ?? addrs.campaignLifecycle ?? "",
