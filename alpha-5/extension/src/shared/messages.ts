...
export type PopupToBackground =
  ...
  | { type: "REQUEST_PUBLISHER_ATTESTATION"; publisherAddress: string; campaignId: string; userAddress: string; firstNonce: string; claimsHash: string; deadlineBlock: string }
