// setup-testnet.ts — Automated post-deploy testnet setup for Alpha-5
//
...
async function main() {
  ...
  // Verify alpha-5 core contracts are present (20 keys; FP contracts checked per-step)
  const coreKeys = [
  ...
  console.log("\nAlpha-5 contract addresses (20 contracts):");
  const alpha5ContractKeys = [
    "pauseRegistry", "timelock", "publishers", "campaigns",
    "budgetLedger", "paymentVault", "campaignLifecycle",
    "attestationVerifier", "governanceV2",
    "settlement", "relay", "zkVerifier",
