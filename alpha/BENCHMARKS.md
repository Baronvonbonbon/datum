...
| `vote (aye)` | 2,304,998,733,791,666 | 2.30 × 10¹⁸ | ~0.230 DOT |
| `vote (nay)` | 2,283,167,806,290,833 | 2.28 × 10¹⁸ | ~0.228 DOT |
...
- `settleClaims` dominates cost due to cross-contract calls (`getCampaignForSettlement`, `deductBudget`) and payment distribution logic.
