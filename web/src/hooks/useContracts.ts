...
import {
  ...
  getCampaignCreativeContract,
  getPowEngineContract,
  getNullifierRegistryContract,
  getSettlementRateLimiterContract,
  getPublisherReputationContract,
  getTagSystemContract,
...
export function useContracts() {
  ...
  return useMemo(() => {
    ...
    return {
      ...
      campaignCreative: getCampaignCreativeContract(addrs, provider),
      powEngine: getPowEngineContract(addrs, provider),
      nullifierRegistry: getNullifierRegistryContract(addrs, provider),
      settlementRateLimiter: getSettlementRateLimiterContract(addrs, provider),
      publisherReputation: getPublisherReputationContract(addrs, provider),
      tagSystem: getTagSystemContract(addrs, provider),
      ...
      clickRegistry: getClickRegistryContract(addrs, provider),
