...
// Legacy publisher dashboard — preserved for reference. The active
// /publisher route now renders the Stage 4b template-driven
// dashboard from ./Dashboard.tsx. The withdraw + tag-edit flows
// from this file will fold into the new dashboard's action hooks
// during follow-up polish; the component is left intact so that
// re-incorporation is easy.
export function PublisherDashboardLegacy() {
