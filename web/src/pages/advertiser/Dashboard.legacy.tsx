...
// Legacy advertiser dashboard — preserved for reference. The active
// /advertiser route now renders the Stage 5a template-driven dashboard
// from ./Dashboard.tsx. The campaign-table, CSV export, and pause/
// resume flows from this file will fold into the new dashboard's
// action hooks during follow-up polish.
export function AdvertiserDashboardLegacy() {
