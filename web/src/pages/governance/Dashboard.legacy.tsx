...
// Legacy governance dashboard — preserved for reference. The active
// /governance route now renders the Stage 5b template-driven
// dashboard from ./Dashboard.tsx.
export function GovernanceDashboardLegacy() {
